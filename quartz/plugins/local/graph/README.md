...
This project vendors the open [PR #7](https://github.com/quartz-community/graph/pull/7)
to support graph nodes for non-ASCII page slugs such as Chinese filenames. Remove
this local override and return to the upstream plugin once that PR is merged and
released.
