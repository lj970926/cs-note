...
import style from "./styles/particle-background.scss"
...
const defaultOptions: Required<ParticleBackgroundOptions> = {
  particleCount: 56,
...
const ParticleBackground = (opts?: ParticleBackgroundOptions): QuartzComponent => {
...
export default ParticleBackground satisfies QuartzComponentConstructor<ParticleBackgroundOptions>
